...
**Важно:** если в системе установлены два контейнерных движка, например, **Docker** и **CRI-O**, необходимо указать параметр **CRI-сокет**: 
`--cri-socket unix:///var/run/crio/crio.sock` при инициализации кластера.
