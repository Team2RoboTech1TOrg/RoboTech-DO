...
В рамках стажировки командой выполнен стартовый этап работы по разработке нейронной сети для управления роем сельскохозяйственных дронов. В рамках работы определены базовые подходы к разработке, определены 
...
[Ниже проиллюстрированы результаты разработки DS](https://github.com/Team2RoboTech1TOrg/RoboTech-DO/blob/main/k8s/images/DS_results.png)
DS_results.png
...
На начальной стадии развития проекта выполнено развертывание инструментов для разработки и мониторинга на основе контейнеров. Описание выполненной работы см. **Docker Compose**.

На следующем этапе было принято решение развернуть кластер **Kubernetes**  со всеми необходимыми инструментами, и погрузиться в изучение "внутреннего мира" **k8s, kubeflow**, вопросов управления ресурсами кластера, и т.п. Информация об этом см. **k8s**.
